...
SPOTIFY_REDIRECT_URI = "https://5000-zhengfabio-zhengfabiogp-uxskculo3z7.ws-eu117.gitpod.io/callback" #dopo il login andiamo qui
...
def home():
    ...
    return render_template('home.html', user_info=user_info, playlists=playlists_info)#avvio dell'app Flask
@app.route('/logout')
def logout():
